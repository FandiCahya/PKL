    ...
    <div class="container-fluid">
        ...
        <div class="row mb-4">
            ...
            <div class="col-lg-6 text-right">
                <a href="{{ route('blocked_tgl.create') }}" class="btn btn-success">Add Blocked Date</a>
            </div>
        </div>

        <div class="card shadow mb-4">
            <div class="card-body" id="blockedDatesTable">
                @include('admin.blocked_tgl.table', ['blockedDates' => $blockedDates])
            </div>
        </div>
    </div>
